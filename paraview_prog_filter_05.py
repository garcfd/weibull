...
for i in range(numPoints):
    ...
    if   prob5 <   2.5:  pointArray[i] = 0.5 # blue (sitting long)
    elif prob5 <   5.0:  pointArray[i] = 1.5 # cyan (sitting short)
    elif prob5 <  10.0:  pointArray[i] = 2.5 # green (walk leisurely)
    elif prob5 <  20.0:  pointArray[i] = 3.5 # yellow (walk fast)
    elif prob5 >= 20.0:  pointArray[i] = 4.5 # red (uncomfortable)
...
for i in range(numPoints):
    ...
    elif prob4  <  5.0:  pointArray[i] = 0.5 # blue (sitting)
    elif prob6  <  5.0:  pointArray[i] = 1.5 # cyan (standing)
    elif prob8  <  5.0:  pointArray[i] = 2.5 # green (strolling)
...
for i in range(numPoints):
    ...
    else prob9p8  >= 1.5:  pointArray[i] = 4.5 # red (uncomfortable)
